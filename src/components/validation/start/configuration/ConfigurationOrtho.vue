...
export default {
  ...
  data() {
    return {
      ...
      errorFile: false,
      examples:[
        {label:'Calciolari 2017', file:'Ortholog-Calciolari_2017.csv', params:{columnNameModel: "Reduced Gene Names", organismModel: "rat", tarOrganismModel: "human", keepEmptyModel: false,resultColumnNameModel: "Ortholog Gene Names"}},
        {label: 'Dong 2020', file: 'Ortholog-Dong_2020.csv', params:{columnNameModel: "Gene Names", organismModel: "mouse", tarOrganismModel: "human", keepEmptyModel: false,resultColumnNameModel: "Ortholog Gene Names"}},
      ]
    }
  },
