...
<!--        </picture>-->
    ...
    <template v-if="step===0">
      ...
      <div style="display: flex; justify-content: center; margin-top: 32px;">
        <v-list-subheader id="overview" :style="{'font-size': mobile ? '1.4rem' : '1.5rem'}">How does ProHarMeD work?
        </v-list-subheader>
      </div>
      <div
        ...
        <template v-if="true">
          <picture class="white--text align-end" style="display: flex; justify-content: center; width: 100%">
            <img :src="getIllustration()" width="80%">
          </picture>
        </template>
      </div>
    </template>
...
import Selection from "@/components/validation/Selection.vue";
